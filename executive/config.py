...
# Faculty Information System alternative API
...
# Accreditation and Certification Information Management System
    ACMIS_ROUTE             = "https://acmis.onrender.com/api/faculty-development/data/"
    @classmethod
    def get_acmis(cls):
        return cls.ACMIS_ROUTE