        ...
        Array.from(
            ...
            0 < e.querySelectorAll(".notification-item").length
                ...
                : (e.querySelector(".view-all") &&
                    ...
                    (e.innerHTML +=
                        '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<i class="ri-notification-2-line" style="font-size: 3rem; margin-left:.5rem;"></i>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function W() {
        var e;
