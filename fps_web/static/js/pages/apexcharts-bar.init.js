...
var chart,
    ...
    chartStackedBarColors =
        (chartDatalabelsBarColors &&
            ((options = {
                series: [
                    { data: [2.8, 2.85, 2.92, 3.45, 3.52, 3.53, 4.61, 4.61, 4.8, 4.9] },
                ],
                ...
                xaxis: {
                    categories: [
                        "Abalos, Karl Christian D."         ,
                        "Aquino, Rodolfo Y.  Jr."           ,
                        "Aribon, Mark Anthony R. III"       ,
                        "Bactasa, Melanie F."               ,
                        "Baltazar, Mary Ann Micah R., CPA"  ,
                        "Banate, Richard B., CPA"           ,
                        "Bernardino, Abraham Seth R."       ,
                        "Bernardino, Girlie F."             ,
                        "Bulawit, Berna A."                 ,
                        "Calingasan, Francisco S."          ,
                    ],
                },
                yaxis: { labels: { show: !1 } },
                title: {
                ...
                subtitle: {
                    text: "Top 10 High Performing Faculties after Reduced Worklaod",
                    align: "center",
                },
                tooltip: {
                    theme: "dark",
    ...
    chartStackedBar100Colors =
        (chartStackedBarColors &&
            ((options = {
                ...
                (chart = new ApexCharts(
                    document.querySelector("#stacked_bar"),
                    options
                )).render()),
            getChartColorsArray("stacked_bar_100")),
    chartNegativeBarColors =
        (chartStackedBar100Colors &&
            ((options = {
                series: [
                    { name: "Marine Sprite", data: [44, 55, 41, 37, 22, 43, 21] },
                ...
                plotOptions: { bar: { horizontal: !0 } },
                stroke: { width: 1, colors: ["#fff"] },
                title: { text: "100% Stacked Bar", style: { fontWeight: 500 } },
                ...
                (chart = new ApexCharts(
                    document.querySelector("#stacked_bar_100"),
                    options
                )).render()),
            getChartColorsArray("negative_bars")),
    chartBarMarkersColors =
        (chartNegativeBarColors &&
            ((options = {
                series: [
                    {
                ...
                (chart = new ApexCharts(
                    document.querySelector("#negative_bars"),
                    options
                )).render()),
            getChartColorsArray("bar_markers")),
    chartBarReversedColors =
        (chartBarMarkersColors &&
            ((options = {
                series: [
                    {
                ...
                legend: {
                    ...
                    markers: { fillColors: chartBarMarkersColors },
                },
            }),
                (chart = new ApexCharts(
                    document.querySelector("#bar_markers"),
                    options
                )).render()),
            getChartColorsArray("reversed_bars")),
    chartPatternedColors =
        (chartBarReversedColors &&
            ((options = {
                ...
                annotations: {
                    ...
                    yaxis: [
                        { y: "July", y2: "September", label: { text: "Y annotation" } },
                    ],
                },
                ...
                (chart = new ApexCharts(
                    document.querySelector("#reversed_bars"),
                    options
                )).render()),
            getChartColorsArray("patterned_bars")),
    chartGroupbarColors =
        (chartPatternedColors &&
            ((options = {
                series: [
                ...
                chart: {
                    ...
                    height: 350,
                    stacked: !0,
                    dropShadow: { enabled: !0, blur: 1, opacity: 0.25 },
                    toolbar: { show: !1 },
                },
                plotOptions: { bar: { horizontal: !0, barHeight: "60%" } },
                dataLabels: { enabled: !1 },
                stroke: { width: 2 },
                title: { text: "Compare Sales Strategy", style: { fontWeight: 500 } },
                xaxis: { categories: [2008, 2009, 2010, 2011, 2012, 2013, 2014] },
                yaxis: { title: { text: void 0 } },
                tooltip: {
                    shared: !1,
                ...
                (chart = new ApexCharts(
                    document.querySelector("#patterned_bars"),
                    options
                )).render()),
            getChartColorsArray("grouped_bar")),
    options =
        (chartGroupbarColors &&
            ((options = {
                series: [
                ...
                (chart = new ApexCharts(
                    document.querySelector("#grouped_bar"),
                    options
                )).render()),
        {
            series: [
