...
var posList,
        ...
        (chartLineStackedColors &&
            ((chartDom = document.getElementById("chart-line-stacked")),
                ...
                (option = {
                    ...
                    legend: {
                        data: ["Average Performance of Institution", "Email", "Union Ads", "Video Ads"],
                        textStyle: { color: "#858d98" },
                    },
                    grid: { left: "0%", right: "0%", bottom: "0%", containLabel: !0 },
                    ...
                    series: [
                        {
                            name: "Average Performance of Institution",
                            type: "line",
                            stack: "Total",
                            data: [3.8, 4.6, 3.7, 1.0, 4.3, 4.3, 1.5],
                        },
                        {
                            name: "Email",
                            type: "line",
                            ...
                            data: [5.0, 1.3, 1.0, 1.3, 1.9, 2.3, 2.1],
                        },
                        {
                            name: "Union Ads",
                            type: "line",
                            ...
                            // areaStyle: {},
                            // emphasis: { focus: "series" },
                            data: [2.0, 1.8, 1.0, 1.0, 2.9, 3.3, 3.1],
                        },
                        {
                            name: "Video Ads",
                            type: "line",
                            ...
                            // areaStyle: {},
                            // emphasis: { focus: "series" },
                            data: [2.5, 2.3, 2.0, 1.5, 1.9, 3.3, 4.1],
                        },
                    ],
        ...
        (chartAreaStackedColors &&
            ((chartDom = document.getElementById("chart-area-stacked")),
                ...
                (option = {
                    ...
                    legend: {
                        data: ["Assync. Classes", "Synchronus Classes", "Trainings"],
                        textStyle: { color: "#858d98" },
                    },
                    toolbox: { feature: { saveAsImage: {} } },
                    grid: { left: "0%", right: "0%", bottom: "0%", containLabel: !0 },
                    ...
                    series: [
                        {
                            ...
                            areaStyle: {},
                            emphasis: { focus: "series" },
                            data: [3, 15, 8, 14, 10, 12, 3],
                        },
                        {
                            name: "Synchronus Classes",
                            type: "line",
                            stack: "Total",
                            areaStyle: {},
                            emphasis: { focus: "series" },
                            data: [4, 12, 3, 20, 14, 8, 5],
                        },
                        {
                            name: "Trainings",
                            type: "line",
        ...
        (chartLineYColors &&
            ((chartDom = document.getElementById("chart-line-y-category")),
                ...
                (option = {
                    ...
                    grid: { left: "1%", right: "0%", bottom: "0%", containLabel: !0 },
                    xAxis: {
                        type: "value",
    ...
    app =
        (chartBarColors &&
            ...
            myChart.setOption(option),
            {}),
    chartBarLabelRotationColors = getChartColorsArray("chart-bar-label-rotation"),
            ...
            ((chartDom = document.getElementById("chart-bar-label-rotation")),
                ...
                (app.config = {
                    ...
                    onChange: function () {
                        ...
                        myChart.setOption({
                            series: [{ label: t }, { label: t }, { label: t }, { label: t }],
                        });
                    },
                }),
                (option = {
                    ...
                    legend: {
                        data: ["Research Contributions", "High Faculty Rating", "High Student Rating", "High Average Overall Rating"],
                        textStyle: { color: "#858d98" },
                    },
                    ...
                    series: [
                        ...
                        {
                            name: "High Average Overall Rating",
                            type: "bar",
                            label: labelOption,
                            emphasis: { focus: "series" },
        ...
        (chartBarHorizontalColors &&
            ((chartDom = document.getElementById("chart-horizontal-bar")),
                ...
                (option = {
                    ...
                    grid: { left: "0%", right: "4%", bottom: "0%", containLabel: !0 },
                    xAxis: {
                        type: "value",
                        boundaryGap: [0, 0.01],
                        axisLine: { lineStyle: { color: "#858d98" } },
    ...
    chartPieColors =
        (chartBarStackedColors &&
            ((chartDom = document.getElementById("chart-horizontal-bar-stacked")),
                (myChart = echarts.init(chartDom)),
                (option = {
                    tooltip: { trigger: "axis", axisPointer: { type: "shadow" } },
                    legend: { textStyle: { color: "#858d98" } },
                    grid: { left: "1%", right: "3%", bottom: "0%", containLabel: !0 },
                    xAxis: {
                        type: "value",
                        axisLine: { lineStyle: { color: "#858d98" } },
                        splitLine: { lineStyle: { color: "rgba(133, 141, 152, 0.1)" } },
                    ...
                    series: [
                        {
                            ...
                            radius: "50%",
                            data: [
                                { value: 13, name: "Disbursement" },
                                { value: 10, name: "Accounting" },
                                { value: 8, name: "Library" },
                                { value: 15, name: "Academic Affairs" },
                                { value: 3, name: "Registrar" },
                            ],
                            emphasis: {
                                itemStyle: {
                                    shadowBlur: 10,
    ...
    chartScatterColors =
        (chartDoughnutColors &&
            ((chartDom = document.getElementById("chart-doughnut")),
                ...
                (option = {
                    tooltip: { trigger: "item" },
                    legend: { top: "5%", left: "center", textStyle: { color: "#858d98" } },
                    ...
                    series: [
                        {
                            ...
                            data: [{ title: { color: "#858d98" }, value: 50, name: "SCORE" }],
                        },
                    ],
                })) &&
            myChart.setOption(option),
