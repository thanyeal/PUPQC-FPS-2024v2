...
document.addEventListener("DOMContentLoaded", function () {
    var jsonDataElement = document.getElementById("table-gridjs");
    
    var jsonData = jsonDataElement.getAttribute("data-json-data");
    console.log('Raw JSON Data:', jsonData);

    var parsedData = JSON.parse(jsonData);

    var transformedData = parsedData.map(cell => cell.fields);
