...
!(function (e, t) {
    ...
    var t = function (e, t) {
        ...
        d = function (e, t, n, r) {
            ...
            return (
                t
                    ...
                    .forEach(function (e) {
                        p(u.inner, Object.assign({}, e.inner)),
                            p(u.outer, Object.assign({}, e.outer));
                    }),
                E(u.inner),
        ...
        O = function (e, t) {
            var n = t.opacity,
                ...
                T = "";
            (h(f) || h(d)) &&
                (T += "transform-origin: " + (f || 0) + "px " + (d || 0) + "px;"),
                h(r) && (_ += "perspective(" + r + "px) "),
                (h(o) || h(i)) &&
                (_ += "translate3d(" + (o || 0) + "px, " + (i || 0) + "px, 0) "),
                (h(a) || h(s)) &&
                (_ += "scale3d(" + (h(a) ? a : 1) + ", " + (h(s) ? s : 1) + ", 1) "),
                h(c) && (_ += "rotateZ(" + c + "rad) "),
                h(u) && (_ += "rotateX(" + u + "rad) "),
                h(l) && (_ += "rotateY(" + l + "rad) "),
                ...
                return (
                    ...
                    }),
                    {
                        write: function () {
                            if (R(s, n))
                                return (
                                    O(i.element, n), Object.assign(s, Object.assign({}, n)), !0
                                );
                        },
                        destroy: function () { },
                    }
        ...
        x = function (e) {
            ...
            var n = C(e).trim();
            return /MB$/i.test(n)
                ? ((n = n.replace(/MB$i/, "").trim()), F(n) * t * t)
                : /KB/i.test(n)
                    ? ((n = n.replace(/KB$i/, "").trim()), F(n) * t)
                    : F(n);
        },
        Y = function (e) {
    ...
    var ce,
        ...
        Ze = function (e) {
            ...
            return (function (e, t) {
                for (
                    var n = new ArrayBuffer(e.length), r = new Uint8Array(n), o = 0;
                    o < e.length;
                    o++
                )
                    r[o] = e.charCodeAt(o);
                            ...
                            (t.request = e(
                                ...
                                function (e, n, o) {
                                    o && (t.size = o),
                                        (t.duration = Date.now() - t.timestamp),
                                        e
                                            ? ((t.progress = n / o), r.fire("progress", t.progress))
                                            : (t.progress = null);
                                },
                                function () {
                                    r.fire("abort");
                    ...
                    load: function () {
                        ...
                        r.fire("init", i),
                            i instanceof File
                                ? r.fire("load", i)
                                : i instanceof Blob
                                    ? r.fire("load", We(i, i.name))
                                    : Ye(i)
                                        ? r.fire("load", We(Ze(i), e, null, o))
                                        : n(i);
                    },
                });
            return r;
                    ...
                    (c.onload = function (e) {
                        ...
                        i(
                            ot(
                                "load",
                                e.status,
                                "HEAD" === t.method ? null : We(n(e.response), a),
                                r
                            )
                        );
                    }),
                ...
                T.serverId
                    ...
                    : (function (i) {
                        ...
                        var u =
                            "function" == typeof t.headers
                                ? t.headers(r, o)
                                : Object.assign({}, t.headers, { "Upload-Length": r.size }),
                        ...
                        return function (o, i, a, s, u, l, c) {
                            if (o) {
                                ...
                                if (o instanceof Blob && p)
                                    return Et(e, t, n, o, i, a, s, u, l, c, r);
                                var E =
                                    t.ondata ||
                                    function (e) {
                                        return e;
                                ...
                                H(i) && m.append(n, JSON.stringify(i)),
                                    (o instanceof Blob ? [{ name: null, file: o }] : o).forEach(
                                        function (e) {
                                            m.append(
                                                n,
                                                e.file,
                            ...
                            (n.request = e(
                                ...
                                function (e) {
                                    n.perceivedPerformanceUpdater.clear(),
                                        s.fire(
                                            "error",
                                            H(e) ? e : { type: "error", code: 0, body: "" + e }
                                        );
                                },
                                function (e, t, r) {
                                    (n.duration = Date.now() - n.timestamp),
                                ...
                                function () {
                                    n.perceivedPerformanceUpdater.clear(),
                                        s.fire("abort", n.response ? n.response.body : null);
                                },
                                function (e) {
                                    s.fire("transfer", e);
                                }
            ...
            var e =
                ...
                c = function (e, t, n) {
                    ...
                    r.forEach(function (e) {
                        ...
                        ((a[i] = t),
                            l("metadata-update", { key: o, value: s[o], silent: n }));
                },
                f = Object.assign(
                    {
                        id: {
        ...
        bt = function (e, t) {
            return function () {
                ...
                l
                    ? t(l, i, s, u || {})
                    : s({ error: ot("error", 0, "Item not found"), file: null });
            };
        },
        Pt = function (e, t, n) {
            return {
                    ...
                    i.forEach(function (t) {
                        ...
                        o.forEach(function (t, n) {
                            i.find(function (e) {
                                ...
                                e(
                                    "ADD_ITEM",
                                    Object.assign({}, t, { interactionMethod: re, index: n })
                                );
                        });
                },
                                ...
                                if (t("IS_ASYNC")) {
                                    ...
                                    return r.status === Ie.PROCESSING_COMPLETE
                                        ? ((s = n.options.instantUpload),
                                            void r
                                                .revert(
                                                    Tt(n.options.server.url, n.options.server.revert),
                                                    t("GET_FORCE_REVERT")
                                                )
                                                .then(s ? u : function () { })
                                                .catch(function () { }))
                ...
                MOVE_ITEM: function (e) {
                    ...
                    if (o) {
                        ...
                        i !== (r = xe(r, 0, n.items.length - 1)) &&
                            n.items.splice(r, 0, n.items.splice(i, 1)[0]);
                    }
                },
                SORT: function (r) {
                    var o = r.compare;
                ...
                ADD_ITEM: function (r) {
                    ...
                    if (M(o)) f({ error: ot("error", 0, "No source"), file: null });
                        ...
                        !ht(o) ||
                        !n.options.ignoredFiles.includes(o.name.toLowerCase())
                    ) {
                        if (
                            !(function (e) {
                                                ...
                                                r
                                                    ? e(
                                                        "REQUEST_PREPARE_OUTPUT",
                                                        {
                                                            ...
                                                            item: v,
                                                            success: function (t) {
                                                                e("DID_PREPARE_OUTPUT", { id: h, file: t }),
                                                                    a();
                                                            },
                                                        },
                                                        !0
                ...
                REQUEST_PREPARE_OUTPUT: function (e) {
                    ...
                    Oe("PREPARE_OUTPUT", n.file, { query: t, item: n }).then(function (
                        e
                    ) {
                        Oe("COMPLETE_PREPARE_OUTPUT", e, { query: t, item: n }).then(
                            function (e) {
                                if (n.archived) return i(a);
                                r(e);
                            }
                    ...
                    if (r.status === Ie.IDLE || r.status === Ie.PROCESSING_ERROR)
                        r.status !== Ie.PROCESSING_QUEUED &&
                            (r.requestProcessing(),
                                ...
                                e("PROCESS_ITEM", { query: r, success: o, failure: i }, !0));
                    else {
                        var a = function () {
                        ...
                        r.status === Ie.PROCESSING_COMPLETE ||
                            r.status === Ie.PROCESSING_REVERT_ERROR
                            ? r
                                .revert(
                                    Tt(n.options.server.url, n.options.server.revert),
                                    t("GET_FORCE_REVERT")
                        ...
                        if (r.status !== Ie.PROCESSING) {
                            ...
                            r.onOnce("process-complete", function () {
                                ...
                                if (
                                    ...
                                    var a = function () { };
                                    (r.origin = ve.LIMBO),
                                        n.options.server.remove(r.source, a, a);
                                }
                                t("GET_ITEMS_BY_STATUS", Ie.PROCESSING_COMPLETE).length ===
                ...
                REMOVE_ITEM: bt(n, function (r, o, i, a) {
                    var s = function () {
                        var t = r.id;
                        Rt(n.items, t).archive(),
                            e("DID_REMOVE_ITEM", { error: null, id: t, item: r }),
                            St(e, n),
                            o(Te(r));
                    },
                        u = n.options.server;
        ...
        Bt = S({
            ...
            write: function (e) {
                ...
                if (0 !== n.opacity) {
                    ...
                    r(t.ref.path, "d", u),
                        r(t.ref.path, "stroke-opacity", n.spin || n.progress > 0 ? 1 : 0);
                }
            },
            mixins: {
        ...
        Ft = S({
            ...
            create: function (e) {
                var t = e.root,
                    n = e.props;
                (t.element.innerHTML = (n.icon || "") + "<span>" + n.label + "</span>"),
                    (n.isDisabled = !1);
            },
            write: function (e) {
                var t = e.root,
                ...
                i && !o
                    ...
                    : !i &&
                    o &&
                    ((n.isDisabled = !1), t.element.removeAttribute("disabled"));
            },
        }),
        qt = function (e) {
            var t =
            ...
            var t = e.root,
                ...
                r =
                    null === n.progress
                        ...
                        : t.query("GET_LABEL_FILE_LOADING") + " " + jt(n.progress) + "%";
        ...
        zt = S({
            ...
            write: A({
                ...
                DID_REQUEST_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Nt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")),
                        Nt(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"));
                },
                DID_ABORT_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Nt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")),
                        Nt(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"));
                },
                DID_COMPLETE_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Nt(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")),
                        Nt(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"));
                },
    ...
    var Kt,
        ...
        cn = S({
            create: function (e) {
                ...
                if (
                    ...
                    (E.info.translateX = tn),
                        (E.info.translateY = en),
                        (E.status.translateY = en),
                ...
                if (
                    ...
                    (_.info.translateX = $t),
                        (_.status.translateY = en),
                        (_.processingCompleteIndicator = {
                            opacity: 1,
                            scaleX: 1,
                            scaleY: 1,
                        });
        ...
        fn = S({
            create: function (e) {
                var t = e.root,
                    n = e.props;
                (t.ref.fileName = Ct("legend")),
                    t.appendChild(t.ref.fileName),
                    (t.ref.file = t.appendChildView(t.createChildView(cn, { id: n.id }))),
                    (t.ref.data = !1);
            },
            ignoreRect: !0,
            write: A({
            ...
            function (e) {
                ...
                i &&
                    ...
                    ((r.currentState = i.type),
                        (t.element.dataset.filepondItemState = Tn[r.currentState] || ""));
                var a =
                ...
                if (a) {
                    ...
                    var T = {
                        ...
                        getGridIndex: function () {
                            return f > Rn.getHeight || f < 0 || c > Rn.getWidth || c < 0
                                ? u
                                : this.y * E + this.x;
                        },
        ...
        bn = S({
            create: function (e) {
                var t = e.root,
                    n = e.props;
                (t.ref.list = t.appendChildView(t.createChildView(An))),
        ...
        Mn = function (e) {
            ...
            t.query("GET_ALLOW_SYNC_ACCEPT_ATTRIBUTE") &&
                Pn(t.element, "accept", !!n.value, n.value ? n.value.join(",") : "");
        },
        wn = function (e) {
            var t = e.root,
                n = e.action;
        ...
        Gn = function (e) {
            var t = e.root;
            e.action.value
                ? 0 === t.query("GET_TOTAL_ITEMS") && Pn(t.element, "required", !0)
                : Pn(t.element, "required", !1);
        },
        Un = function (e) {
            var t = e.root,
                n = e.action;
        ...
        Bn = function (e) {
            ...
            t.query("GET_TOTAL_ITEMS") > 0
                ...
                : (Pn(n, "name", !0, t.query("GET_NAME")),
                    t.query("GET_CHECK_VALIDITY") && n.setCustomValidity(""),
                    t.query("GET_REQUIRED") && Pn(n, "required", !0));
        },
        Fn = S({
            tag: "input",
            name: "browser",
            ...
            write: A({
                ...
                DID_THROW_ITEM_INVALID: function (e) {
                    ...
                    t.query("GET_CHECK_VALIDITY") &&
                        t.element.setCustomValidity(t.query("GET_LABEL_INVALID_FIELD"));
                },
                DID_SET_DISABLED: Nn,
        ...
        Zn = A({
            ...
            DID_ADD_ITEM: function (e) {
                var t = e.root,
                    n = e.action,
                    r =
                        !(t.query("GET_ITEM", n.id).origin === ve.LOCAL) &&
            ...
            DID_LOAD_ITEM: function (e) {
                ...
                if (
                    r &&
                    (null !== n.serverFileReference && (r.value = n.serverFileReference),
                        t.query("SHOULD_UPDATE_FILE_INPUT"))
                ) {
            ...
            DID_DEFINE_VALUE: function (e) {
                var t = e.root,
                    ...
                    r = Wn(t, n.id);
                r &&
                    (null === n.value ? r.removeAttribute("value") : (r.value = n.value),
                        zn(t));
            },
        ...
        ur = function (e) {
            ...
            var t = e.lastModifiedDate,
                ...
                r = tr(je(e.name));
            return r.length
                ? (((e = e.slice(0, e.size, r)).name = n), (e.lastModifiedDate = t), e)
                : e;
        },
        lr = function (e) {
                ...
                nr(n).then(function (r) {
                    ...
                    t.some(function (t) {
                        ...
                        if (f)
                            if (mr(e, a)) {
                                if (((o = !0), null === t.state))
                                    return (t.state = "enter"), void s(Tr(e));
                                if (((t.state = "over"), i && !f)) return void gr(n, "none");
                                l(Tr(e));
                            } else
                                i && !o && gr(n, "none"),
                                    t.state && ((t.state = null), u(Tr(e)));
                        else gr(n, "none");
                    });
                });
            };
                ...
                nr(n).then(function (n) {
                    t.forEach(function (t) {
                        var r = t.filterElement,
                            ...
                            a = t.onexit,
                            s = t.allowdrop;
                        if (((t.state = null), !r || mr(e, o)))
                            return s(n) ? void i(Tr(e), n) : a(Tr(e));
                    });
                });
            };
        },
                ...
                t = {
                    destroy: function () {
                        ...
                        (t = e),
                            de(Lr, Lr.indexOf(t)),
                            0 === Lr.length &&
                            (document.removeEventListener("paste", br), (Ar = !1));
                    },
                    onload: function () { },
                };
            return (
                (function (e) {
                    Lr.includes(e) ||
                        (Lr.push(e),
                            Ar || ((Ar = !0), document.addEventListener("paste", br)));
                })(e),
                t
            );
        },
                    ...
                    if (Ur(t)) {
                        ...
                        Cr.push(r.filename),
                            ...
                            (Mr = setTimeout(function () {
                                Gr(t, Cr.join(", "), t.query("GET_LABEL_FILE_ADDED")),
                                    (Cr.length = 0);
                            }, 750));
                    }
                },
            ...
            o && !e.ref.browser
                ? (e.ref.browser = e.appendChildView(
                    e.createChildView(
                        ...
                        Object.assign({}, t, {
                            onload: function (t) {
                                Oe("ADD_ITEMS", t, { dispatch: e.dispatch }).then(function (
                                    t
                                ) {
                                    if (Xr(e, t)) return !1;
                                    e.dispatch("ADD_ITEMS", {
            ...
            create: function (e) {
                ...
                o &&
                    ...
                    (t.ref.list = t.appendChildView(
                        t.createChildView(bn, { translateY: null })
                    )),
                    (t.ref.panel = t.appendChildView(
                        t.createChildView(En, { name: "panel-root" })
                    )),
                    (t.ref.assistant = t.appendChildView(
                        t.createChildView(qr, Object.assign({}, n))
                    )),
                    (t.ref.data = t.appendChildView(
                        t.createChildView(Kn, Object.assign({}, n))
                    )),
                ...
                t.query("GET_ALLOW_REORDER") &&
                    a &&
                    !i &&
                    (t.element.addEventListener("touchmove", Yr, { passive: !1 }),
            ...
            write: function (e) {
                ...
                if (
                    ...
                    var T = kr(t),
                        ...
                        O = m + h + I.bounds + g;
                    if (
                        ((u.translateY = Math.max(0, m - u.rect.element.marginTop) - T.top),
                            c)
                    ) {
                        var y = t.rect.element.width,
                            D = y * c;
                        c !== t.ref.previousAspectRatio &&
                            ((t.ref.previousAspectRatio = c), (t.ref.updateHistory = []));
                        ...
                        R > o.cappedHeight && I.visual > U
                            ? (u.overflow = U)
                            : (u.overflow = null),
                            (t.height = Math.min(o.cappedHeight, O - T.top - T.bottom));
                    } else {
                ...
                I = {
                    _read: function () {
                        u &&
                            ((f = window.innerWidth),
                                c || (c = f),
                                l || f === c || (i.dispatch("DID_START_RESIZE"), (l = !0))),
    ...
    if (
        ...
        !(function (e, t) {
            var n =
                ...
                r = "__framePainter";
            if (window[r])
                return window[r].readers.push(e), void window[r].writers.push(t);
