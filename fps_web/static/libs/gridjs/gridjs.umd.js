!(function (t, n) {
    ...
    function E(t) {
        ((!t.__d && (t.__d = !0) && h.push(t) && !T.__r++) ||
            _ !== f.debounceRendering) &&
            ((_ = f.debounceRendering) || setTimeout)(T);
    }
    function T() {
        ...
        try {
            t: if ("function" == typeof E) {
                ...
                (c.state = c.__s),
                    ...
                    m && (c.__E = c.__ = null),
                    (c.__e = !1);
            } else null == i && n.__v === e.__v ? ((n.__k = e.__k), (n.__e = e.__e)) : (n.__e = O(e.__e, n, e, r, o, i, u, a));
            (l = f.diffed) && l(n);
        } catch (t) {
            (n.__v = null),
                (a || null != i) &&
    ...
    function gt(t, n) {
        var e = mt(rt++, 3);
        !f.__s && Pt(e.__H, n) && ((e.__ = t), (e.i = n), ot.__H.__h.push(e));
    }
    function yt(t) {
        return (
            (at = 5),
    ...
    function bt(t, n) {
        var e = mt(rt++, 7);
        return Pt(e.__H, n) ? ((e.__V = t()), (e.i = n), (e.__h = t), e.__V) : e.__;
    }
    function wt() {
    ...
    (f.__b = function (t) {
        ...
        (f.diffed = function (t) {
            ...
            n &&
                n.__H &&
                (n.__H.__h.length &&
                    ((1 !== lt.push(n) && ut === f.requestAnimationFrame) ||
                        ((ut = f.requestAnimationFrame) || kt)(wt)),
    ...
    (t.PluginPosition = void 0),
        ((qt = t.PluginPosition || (t.PluginPosition = {}))[(qt.Header = 0)] =
            "Header"),
    ...
    function $t(t) {
        ...
        if (t.pluginId) {
            ...
            return o ? x(S, {}, x(o.component, r({ plugin: o }, t.props))) : null;
        }
    ...
    var Gt = /*#__PURE__*/ (function (n) {
        ...
        return (
            (u.adjustWidth = function (t, n, e) {
                ...
                n.current &&
                    u &&
                    (q(x(Wt, { tableRef: n.current }), e.current),
                        (l = (function (t) {
        ...
        fn = /*#__PURE__*/ (function () {
            ...
            return (
                ...
                (n.defaultConfig = function () {
                    return {
                        store: new ln({ status: l.Init, header: void 0, data: null }),
                        plugin: new Vt(),
                ...
                (n.fromPartialConfig = function (e) {
                    ...
                    return (
                        ...
                        r.assign({ header: Gt.createFromConfig(r) }),
                        r.assign({ storage: Jt.createFromConfig(r) }),
                        r.assign({ pipeline: an.createFromConfig(r) }),
                        r.assign({ translator: new It(r.language) }),
                        r.search &&
                        r.plugin.add({
                            id: "search",
        ...
        return x(
            ...
            t.children
                ...
                : t.row.cells.map(function (n, r) {
                    ...
                    return o && o.hidden
                        ? null
                        : x(pn, { key: n.id, cell: n, row: t.row, column: o });
                })
        );
    }
    function hn(t) {
        ...
        gn = function (t, n, e) {
            return function (o) {
                ...
                return r(
                    {},
                    o,
                    i ? vn(t, 1 === i.direction ? -1 : 1, n, e)(o) : vn(t, 1, n, e)(o)
                );
            };
        },
        ...
        var d = function () {
            ...
            return (
                ...
                0 === n.pipeline.getStepsByType(t).length
                    ? t === K.ServerSort
                        ? new yn(r({ columns: c ? c.columns : [] }, p.server))
            ...
            x(
                ...
                void 0 !== t.column.name
                    ...
                    : void 0 !== t.column.plugin
                        ? x($t, { pluginId: t.column.plugin.id, props: { column: t.column } })
                        : null
            ),
            l() && x(bn, r({ index: t.index }, t.column.sort)),
            t.column.resizable &&
            t.index < n.header.visibleColumns.length - 1 &&
            x(wn, { column: t.column, thRef: e })
        );
    }
    function kn() {
        var t,
        ...
        return (
            ...
            e
                ? x(
                    ...
                    x($t, { position: t.PluginPosition.Header })
                )
                : null
        );
    }
        ...
        return (
            ...
            o
                ? x(
                    ...
                    x($t, { position: t.PluginPosition.Footer })
                )
                : null
        );
    }
        ...
        return x(
            "div",
            {
                ...
                className: et(
                    "gridjs",
                    nt("container"),
                    e === l.Loading ? nt("loading") : null,
                    t.className.container
                ),
                style: r({}, t.style.container, { width: t.width }),
            },
            e === l.Loading && x("div", { className: nt("loading-bar") }),
            x(Pn, null),
            x(
                "div",
            ...
            x(Cn, null),
            x("div", { ref: u, id: "gridjs-temp", className: nt("temp") })
        );
    }
    var Tn = /*#__PURE__*/ (function (t) {
        ...
        return (
            ...
            (e.createElement = function () {
                return x(cn.Provider, { value: this.config, children: x(En, {}) });
            }),
